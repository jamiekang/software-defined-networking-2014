...
-}
c0 = WRT(acl_tbl, [("srcmac", 6543), ("dstmac", 5432)], 0)    -- Write srcmac=6543 and dstmac=5432 at index 0
c1 = WRT(acl_tbl, [("srcmac", 4321), ("dstmac", 1234)], 1)   -- write Write srcmac=4321 and dstmac=1234 at index 1
